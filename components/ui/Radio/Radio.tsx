...
function RadioGroup({
  ...
  let classes = [RadioStyles['fui-radio-fieldset']];

  if (type === 'cards') {
    classes.push(RadioStyles['fui-radio-fieldset--cards']);
  }
  ...
  return (
    ...
    >
      <fieldset className={RadioStyles['fui-radio-fieldset']}>
        <FormLayout
          label={label}
          ...
          size={size}
        >
          <div className={RadioStyles['fui-radio-group-contents']}>
  ...
  return (
    <RadioContext.Consumer>
      {({ parentCallback, type, name, activeId, parentSize }) => {
        ...
        let classes = [
          RadioStyles['fui-radio-container'],
          RadioStyles['fui-radio-label'],
          RadioStyles[`fui-radio-container--${parentSize ? parentSize : size}`],
        ];
        if (type === 'cards') {
          classes.push(RadioStyles['fui-radio-container--card']);
        }
        if (type === 'cards' && active) {
          classes.push(RadioStyles['fui-radio-container--card--active']);
        }
        ...
        return (
          <label id={id} className={classes.join(' ')}>
            <input
              ...
              name={markupName}
              type='radio'
              className={RadioStyles['fui-radio']}
              checked={active}
              disabled={disabled}
            ...
            />
            <div>
              <span className={RadioStyles['fui-radio-label-text']}>
                {beforeLabel && (
                  <span className={RadioStyles['fui-radio__label-text-before']}>
                    {beforeLabel}
                  </span>
                )}
                {label}
                {afterLabel && (
                  <span className={RadioStyles['fui-radio__label-text-after']}>
                    {afterLabel}
                  </span>
                )}
              </span>
              ...
              {description && (
                <span className={RadioStyles['fui-radio-label-description']}>
                  {description}
                </span>
              )}
            </div>
